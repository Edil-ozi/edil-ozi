  ...
  const buttons = [
    {
      ...
      component: (
        <button className="rounded-md px-8 py-2 text-sm font-semibold text-black transition hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus:ring-gray-400 dark:text-white dark:hover:bg-gray-900 dark:focus:ring-gray-700">
          Base
        </button>
      ),
    },

    {
      ...
      component: (
        <button
          type="button"
          className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-200 bg-[linear-gradient(110deg,#fff,45%,#f1f1f1,55%,#fff)] bg-[length:200%_100%] px-6 font-medium text-slate-600 transition-colors focus:outline-none focus-visible:ring-2 focus:ring-slate-700 focus:ring-offset-2 focus:ring-offset-slate-400 dark:border-slate-800 dark:bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] dark:text-slate-400 dark:focus:ring-slate-300"
        >
          Shimmer
        </button>
      ),
...

    {
      ...
      component: (
        <button
          type="button"
          className="group relative h-10 rounded-sm bg-slate-300 px-6 text-sm font-medium text-slate-800 shadow-md focus:outline-none focus-visible:ring focus:ring-slate-400 focus:ring-offset-1 focus:ring-offset-transparent dark:bg-slate-600 dark:text-white"
        >
          Hover me
...

    {
      ...
      component: (
        <button
          type="button"
          className="group relative inline-block cursor-pointer rounded-full border-none bg-slate-100 p-0.5 text-xs font-semibold leading-6 text-white no-underline outline-none focus-visible:ring-1 focus:ring-slate-400 focus:ring-offset-1 focus:ring-offset-slate-100 dark:bg-slate-800 dark:focus:ring-slate-400 dark:focus:ring-offset-slate-950"
        >
...

    {
      ...
      component: (
        <button
          type="button"
          className="relative overflow-hidden rounded-sm border-2 border-solid border-emerald-500 px-4 py-2 text-sm text-black transition-colors duration-700 ease-out before:absolute before:-left-10 before:top-0 before:z-[-1] before:h-full before:w-[0%] before:skew-x-[45deg] before:bg-emerald-500 before:transition-all before:delay-75 before:duration-700 before:content-[''] hover:before:w-[150%] focus:outline-none focus-visible:ring-2 focus:ring-emerald-400 focus:ring-offset-1 focus:ring-offset-white focus:before:w-[150%] dark:border-emerald-700 dark:text-white dark:before:bg-emerald-700 dark:focus:ring-emerald-800 dark:focus:ring-offset-black"
        >
          Diagonal Swipe
        </button>
      ),
...

    {
      ...
      component: (
        <button
          type="button"
          className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-slate-200 bg-white px-6 py-1.5 text-xs font-medium text-slate-600 transition-colors duration-300 ease-in hover:shadow-[#000103]/50 focus:outline-none focus-visible:ring-2 focus:ring-slate-700 focus:ring-offset-2 focus:ring-offset-slate-400 dark:border-slate-800 dark:bg-[#000103] dark:text-slate-400"
        >
...

    {
      ...
      component: (
        <button
          type="button"
          className="h-10 rounded-md border border-cyan-700 px-6 text-center text-sm font-medium text-cyan-700 transition hover:bg-cyan-600 hover:text-white focus:outline-none focus-visible:ring-2 focus:ring-cyan-300 focus:ring-offset-2 focus:ring-offset-transparent dark:border-cyan-500 dark:text-cyan-500 dark:hover:bg-cyan-600 dark:hover:text-white dark:focus:ring-cyan-800"
        >
          Submit
        </button>
      ),
...

    {
      ...
      component: (
        <button className="mt-6 rounded-full bg-cyan-200 dark:bg-cyan-600 px-12 py-4 text-base tracking-normal font-medium ring-4 ring-cyan-600/50 dark:ring-cyan-600/70 transition duration-300 hover:scale-105 hover:shadow-xl hover:ring-cyan-600/60 focus:outline-none focus-visible:ring-2 focus:ring-cyan-300 focus-visible:ring-offset-4 focus:ring-offset-transparent dark:hover:text-white dark:focus:ring-cyan-800">
          Join for free
        </button>
      ),
    },
