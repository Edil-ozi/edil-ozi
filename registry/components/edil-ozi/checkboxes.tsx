      ...
      component: (
        <label className="block h-[1.5rem] w-[1.5rem] cursor-pointer">
          <input
            ...
            className="peer hidden"
          />
          <span className="duration-[375ms] peer-checked:h-5.5 block h-[inherit] w-[inherit] rounded-md border-[3px] border-black transition-all peer-checked:ml-1 peer-checked:w-3.5 peer-checked:translate-y-[-3px] peer-checked:rotate-45 peer-checked:rounded-none peer-checked:border-l-transparent peer-checked:border-t-transparent dark:border-white" />
        </label>
      ),
    },
    {
      ...
      component: (
        <>
          <label className="flex min-w-56 cursor-pointer items-center justify-between rounded-md bg-white/40 dark:bg-zinc-800/80 p-3 shadow hover:bg-white/20 has-[:checked]:bg-white/30 dark:has-[:checked]:text-sky-200 has-[:checked]:text-indigo-400 has-[:checked]:ring-2 dark:has-[:checked]:ring-sky-200 has-[:checked]:ring-indigo-200">
            ...
            <div className="relative h-[20px] w-[20px] bg-[#eee] border-[3px] border-[#eee]  rounded-[50%] left-0 top-0 after:content-[''] after:absolute after:hidden after:w-[0.25em] after:h-[0.5em] peer-checked:bg-blue-400 peer-checked:after:block;"></div>
          </label>
      ...
      component: (
        ...
        <label className="h-10 group w-10 block relative cursor-pointer select-none transition-[100ms] hover:scale-110">
          <input type="checkbox" className="hidden" />
            ...
            <path className="group-has-[:checked]:fill-[#1c7dff] group-has-[:checked]:stroke-[1.2] stroke-black dark:stroke-white fill-none group-has-[:checked]:stroke-[#f1f1f1] dark:group-has-[:checked]:stroke-[#212121]" strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.3" d="M8 10V20M8 10L4 9.99998V20L8 20M8 10L13.1956 3.93847C13.6886 3.3633 14.4642 3.11604 15.1992 3.29977L15.2467 3.31166C16.5885 3.64711 17.1929 5.21057 16.4258 6.36135L14 9.99998H18.5604C19.8225 9.99998 20.7691 11.1546 20.5216 12.3922L19.3216 18.3922C19.1346 19.3271 18.3138 20 17.3604 20L8 20"></path>
            </svg>
        </label>

        <label className="ui-bookmark">
          <input type="checkbox" className="peer" />
          <div className="w-6 h-auto fill-slate-400 cursor-pointer transition-[0.2s] flex justify-center items-center relative origin-top after:content-[''] after:absolute after:w-2.5 after:h-2.5 after:shadow-[0_30px_0_-4px_gold,30px_0_0_-4px_gold,0_-30px_0_-4px_gold,-30px_0_0_-4px_gold,-22px_22px_0_-4px_gold,-22px_-22px_0_-4px_gold,22px_-22px_0_-4px_gold,22px_22px_0_-4px_gold] after:rounded-[50%] after:scale-0 before:content-[''] before:absolute before:border-1 before:opacity-0 before:rounded-[50%]
          peer-checked:afer:animate-[circles_300ms_cubic-bezier(0.175,0.885,0.32,1.275)_forwards]

          peer-checked:fill-[gold] peer-checked:animate-[bookmark_300ms_forwards] peer-checked:delay-[0.3s] peer-checked:before:animate-[circle_300ms_cubic-bezier(0.175,0.885,0.32,1.275)_forwards]
          ">
