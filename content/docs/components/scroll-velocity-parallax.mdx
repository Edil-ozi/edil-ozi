...
date: 2024-06-14
description: Scroll velocity parallax effect.
tools:
  - Lenis (optional)
---

<ComponentPreview name="scroll-velocity-parallax-demo" />
...
```text
components/edil-ozi/scroll-velocity-parallax.tsx
```

<ComponentSource name="scroll-velocity-parallax" />
...
<ComponentPreview name="scroll-velocity-parallax-noscroll-demo" />
